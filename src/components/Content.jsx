        ...
        <section className="Content" >
            <article className='article' id='home'>
                <div className='About-me'>
                    <h1 className="Mengleang">Hello, I'm Mengleang</h1>
                    <h3 className='header-color'>I'm third 3 years students of ITC</h3>
                    <p>I'm a 3rd-year IT student with a passion for front-end development.
                        I have a strong foundation in programming and a growing skill set in
                        web technologies. I'm eager to apply my knowledge in real-world projects and continue
                        learning and growing as a developer.</p>
                    <a className='contact' href="#Footer">Contact Me</a>
                </div>
                <img src={Mengleang} alt="MyPicture" />
            </article>

            <article className='article2' id='article2'>
                <h1 className='Text-tech'>Tech Knowledge</h1>
                <div className='tech-box'>
                    ...
                    <div className='tech'>
                        <img src="https://img.icons8.com/?size=100&id=HKNzD81eiiSc&format=png&color=000000" alt="" />
                        <span>JQuery</span>
                    </div>
            ...
            <article className='article2'>
                <h1 className='Text-tech'>Tools</h1>
                <div className='tech-box'>

                    <div className='tech'>
                        <img src="https://img.icons8.com/?size=100&id=0OQR1FYCuA9f&format=png&color=000000" alt="VSCode" />
                        <span>VSCODE</span>
                    </div>

                    <div className='tech'>
                        <img src="https://img.icons8.com/?size=100&id=zfHRZ6i1Wg0U&format=png&color=000000" alt="VSCode" />
                        <span>Figma</span>
                    </div>
            ...
            <article className='article3' id='article3'>

                <h1 className='Text-project'>Project</h1>
                <div className='project_box'>

                    <div className='project'>
                        <h3>1. Books Management System</h3>
                        <p>A React-based project where I developed a simple books management system. It includes features like adding, editing, delete, storing in local storage, and listing books with unique IDs and profile pictures.</p>
